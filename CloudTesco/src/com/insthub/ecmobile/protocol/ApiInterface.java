...
{ 
     ...
     public static final String USER_INFO_UPDATE  ="/user/infoUpdate";
     ...
     public static final String COMMENTS  ="/comment/list";
     public static final String COMMENT_ADD  ="/comment/add";
     public static final String ORDER_DETAIL  ="/order/detail";
     public static final String SEARCH  ="/search";
     public static final String CATEGORY  ="/category";
     public static final String LIST_PROMOTE ="/list/promote";
     public static final String LIST_BEST  ="/list/best";
     public static final String LIST_HOT  ="/list/hot";
     public static final String LIST_NEW  ="/list/new";
