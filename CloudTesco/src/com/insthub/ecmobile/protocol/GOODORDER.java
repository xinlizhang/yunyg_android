...
@SuppressLint("ParcelCreator") @Table(name = "GOODORDER")
public class GOODORDER  extends Model
{
 ...
 public void fromJson(JSONObject jsonObject)  throws JSONException
 {
     ...
     ADDR_INFO addrInfo = new ADDR_INFO();
     addrInfo.fromJson(jsonObject.optJSONObject("addr_info"));
 ...
 public JSONObject  toJson() throws JSONException 
 {
     ...
     if(null != addr_info)
     {
    	 localItemObject.put("addr_info", addr_info.toJson());
     }
