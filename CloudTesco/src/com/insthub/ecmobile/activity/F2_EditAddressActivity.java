...
public class F2_EditAddressActivity extends BaseActivity implements BusinessResponse {
	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		mobile = (EditText) findViewById(R.id.address_manage2_mobile);
		...
		change = (Button) findViewById(R.id.top_view_right_btn);
		change.setVisibility(View.VISIBLE);
		change.setText(getBaseContext().getResources().getString(R.string.save));
		...
		top_view_text.setText(getBaseContext().getResources().getString(R.string.modify_address));
		...
		change.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {				
                ...
                String mobile = resource.getString(R.string.add_mobile);
                ...
                if("".equals(consignee)) {
			        ...
			        toast.setGravity(Gravity.CENTER, 0, 0);
			        toast.show();
				} else if("".equals(mobileNum)) {
					Toast toast = Toast.makeText(F2_EditAddressActivity.this, mobile, 0);
			        toast.setGravity(Gravity.CENTER, 0, 0);
			        toast.show();
				} else if("".equals(mail)) {
					...
					addressModel.addressUpdate(address_id, consignee, telNum, mail, mobileNum, zipcode, address, country_id, province_id, city_id, county_id);
				}
			}
		});
	...
	public void setAddressInfo() {		
		...
		mobile.setText(addressModel.address.mobile);
