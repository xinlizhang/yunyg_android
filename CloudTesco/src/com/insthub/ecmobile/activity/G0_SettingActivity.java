...
public class G0_SettingActivity extends BaseActivity implements OnClickListener,BusinessResponse{
    ...
    private LinearLayout myappAbout;
	...
	protected void onCreate(Bundle savedInstanceState)
    {
		...
		myappAbout = (LinearLayout) findViewById(R.id.myapp_about);
		myappAbout.setOnClickListener(this);
	...
	public void onClick(View v) {		
		...
		case R.id.setting_exitLogin:
			...
			break;
		 case R.id.myapp_about:
		    Intent mintent = new Intent(G0_SettingActivity.this, G3_AboutActivity.class);
