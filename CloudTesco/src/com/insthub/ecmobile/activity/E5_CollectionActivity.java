...
public class E5_CollectionActivity extends BaseActivity implements BusinessResponse, IXListViewListener {
	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		top_view_text.setText(getBaseContext().getResources().getString(R.string.collect_myfavorite));
		null_pager = findViewById(R.id.null_pager);
		edit = (Button) findViewById(R.id.top_view_right_btn);
		edit.setVisibility(View.VISIBLE);
		edit.setText(getBaseContext().getResources().getString(R.string.collect_compile));
