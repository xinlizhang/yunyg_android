        ...
        search_input.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {                
            	try {
					...
					Intent it = new Intent(D2_FilterActivity.this, B1_ProductListActivity.class);
					filter.keywords = search_input.getText().toString().toString();
					it.putExtra("filter", filter.toJson().toString());
					it.putExtra("genre", "");
//					D2_FilterActivity.this.setResult(RESULT_OK, it);
					startActivity(it);
...
//					D2_FilterActivity.this.setResult(RESULT_OK, it);
        ...
        back = (ImageView) findViewById(R.id.nav_back_button);
