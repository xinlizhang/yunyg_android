...
public class C4_InvoiceActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		top_view_text.setText(getBaseContext().getResources().getString(R.string.balance_bill));
		...
		save = (Button) findViewById(R.id.top_view_right_btn);
		save.setVisibility(View.VISIBLE);
		save.setText(getBaseContext().getResources().getString(R.string.bill_save));
